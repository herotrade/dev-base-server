...
insert into `menu` (`name`, `meta`, `parent_id`, `updated_at`, `created_at`) values (
    ...
    '{"title":"{{$codeGenerator->menu_name}}列表","i18n":"{{$codeGenerator->getPackageName()}}.{{Str::snake($codeGenerator->getName())}}.list","icon":"","type":"M","hidden":false,"componentPath":"modules\/{{$codeGenerator->getPackageName()}}\/{{$codeGenerator->getName()}}\/","componentSuffix":".vue","breadcrumbEnable":true,"cache":true,"affix":false}',
    @LastInsertId,
    '{{$time}}',
    '{{$time}}'
);
...
insert into `menu` (`name`, `meta`, `parent_id`, `updated_at`, `created_at`) values (
    ...
    '{"title":"{{$codeGenerator->menu_name}}新增","i18n":"{{$codeGenerator->getPackageName()}}.{{Str::snake($codeGenerator->getName())}}.create","icon":"","type":"M","hidden":true,"componentPath":"modules\/{{$codeGenerator->getPackageName()}}\/{{$codeGenerator->getName()}}\/","componentSuffix":".vue","breadcrumbEnable":true,"cache":true,"affix":false}',
    @LastInsertId,
    '{{$time}}',
    '{{$time}}'
);
...
insert into `menu` (`name`, `meta`, `parent_id`, `updated_at`, `created_at`) values (
    ...
    '{"title":"{{$codeGenerator->menu_name}}编辑","i18n":"{{$codeGenerator->getPackageName()}}.{{Str::snake($codeGenerator->getName())}}.update","icon":"","type":"M","hidden":true,"componentPath":"modules\/{{$codeGenerator->getPackageName()}}\/{{$codeGenerator->getName()}}\/","componentSuffix":".vue","breadcrumbEnable":true,"cache":true,"affix":false}',
    @LastInsertId,
    '{{$time}}',
    '{{$time}}'
);
...
insert into `menu` (`name`, `meta`, `parent_id`, `updated_at`, `created_at`) values (
    ...
    '{"title":"{{$codeGenerator->menu_name}}删除","i18n":"{{$codeGenerator->getPackageName()}}.{{Str::snake($codeGenerator->getName())}}.delete","icon":"","type":"M","hidden":true,"componentPath":"modules\/{{$codeGenerator->getPackageName()}}\/{{$codeGenerator->getName()}}\/","componentSuffix":".vue","breadcrumbEnable":true,"cache":true,"affix":false}',
    @LastInsertId,
    '{{$time}}',
    '{{$time}}'
);
